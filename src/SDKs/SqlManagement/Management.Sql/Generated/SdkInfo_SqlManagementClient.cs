...
namespace Microsoft.Azure.Management.Sql
{
  ...
  internal static partial class SdkInfo
  {
      public static IEnumerable<Tuple<string, string, string>> ApiInfo_SqlManagementClient
      {
          get
          {
              return new Tuple<string, string, string>[]
              {
                ...
                new Tuple<string, string, string>("Sql", "InterfaceEndpointProfiles", "2017-10-01-preview"),
      ...
      public static readonly String AutoRestCmdExecuted = "cmd.exe /c autorest.cmd https://github.com/vpyvovar/azure-rest-api-specs/blob/private_preview/specification/sql/resource-manager/readme.md --csharp --version=latest --reflect-api-versions --csharp-sdks-folder=C:\\Users\\amagarwa\\azure-sdk-for-net\\src\\SDKs";
      public static readonly String GithubForkName = "vpyvovar";
      public static readonly String GithubBranchName = "private_preview";
      public static readonly String GithubCommidId = "a0db0a5e822b4d320c7b72251ae29cfcb617d685";
